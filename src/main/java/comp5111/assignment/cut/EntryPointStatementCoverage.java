...
public class EntryPointStatementCoverage {
...
//        System.out.println("Invocation to instance methods: " + Counter.getNumInstanceInvocations());
        System.out.println("Invocation to statement: " + Counter.getNumStatement());
        System.out.println("Total statements: " + InstrumenterStatementCoverage.noStatement);
        System.out.println("Statement coverage: "+ (Counter.getNumStatement()*100/InstrumenterStatementCoverage.noStatement)+"%");
     }
    ...
    private static void instrumentWithSoot() {
        ...
        InstrumenterStatementCoverage instrumenter = new InstrumenterStatementCoverage();
